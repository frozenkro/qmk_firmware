...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      ...
      *                       └───┘   └───┘
      */
    [0] = LAYOUT_42key_split(
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                               KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
        KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                               KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
                                            KC_LALT, LT(1,KC_SPC), LT(2,KC_ESC), LT(2,KB_BSPC),  LT(1,KC_ENT),  KC_RALT
    ),
    [1] = LAYOUT_42key_split(
        ...
        KC_LCTL, KC_Z,    KC_1,    KC_2,    KC_3,    KC_MINS,                            KC_PGDN, KC_M,    KC_COMM, KC_DOT,  KC_BSLS, KC_CAPS,
                                            KC_LGUI, ____, KC_ESC,             KB_DEL,  KC_ENT,  KC_RALT
    ),
    [2] = LAYOUT_42key_split(
        ...
        KC_LCTL, KC_MUTE,  KC_F1,   KC_F2,   KC_F3,    KC_F12,                           KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
                                            KC_LALT, KC_SPC, KC_ESC,             KB_BSPC,  KC_ENT,  KC_RALT
    )
};
