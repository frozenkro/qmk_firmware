...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, KC_Z,     KC_X,    KC_C,   KC_V,    KC_B,                               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,       KC_RCTL,
                                    KC_ESC, LT(1,KC_SPC), MO(2),        LM(2,MOD_LSFT), LT(1,KC_BSPC),  KC_ENT
    ),
    ...
    [2] = LAYOUT_split_3x6_3(
        ...
        _______, KC_VOLD,  KC_F4,   KC_F5,  KC_F6,   KC_F11,                             KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_CAPS, KC_CAPS,
        _______, KC_MUTE,  KC_F1,   KC_F2,  KC_F3,   KC_F12,                             KC_PGDN, _______, _______, _______, KC_PSCR, KC_PSCR,
